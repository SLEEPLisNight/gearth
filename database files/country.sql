...
CREATE TABLE IF NOT EXISTS `country` (
  ...
  `mapreference` varchar(255) DEFAULT NULL,
  `nationalitysingular` varchar(255) DEFAULT NULL,
  `nationalityplural` varchar(255) DEFAULT NULL,
...
INSERT INTO `country` (`countryid`, `country`, `fips104`, `iso2`, `iso3`, `ison`, `internet`, `capital`, `mapreference`, `nationalitysingular`, `nationalityplural`, `currency`, `currencycode`, `population`, `title`, `comment`) VALUES
